...
const Right = () => {
  ...
  return (
    <div className="lg:w-1/2 w-full min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-6">
      <div className="flex flex-col items-center w-full max-w-md">
        {/* Card wrapper */}
        <div className="w-full bg-white rounded-2xl shadow-xl p-8 backdrop-blur-sm border border-gray-100">
          {/* Header Section */}
          <div className="mb-10">
            ...
            <div className="flex p-1.5 bg-gray-50 rounded-xl border border-gray-100">
              <button
                className={`flex-1 py-3 px-6 rounded-lg transition-all duration-300 font-medium flex items-center justify-center gap-2.5 ${
                  selected === "SAAS"
          ...
          {selected === "SAAS" ? (
            <div className="w-full space-y-4">
              {[
                { name: "Github", icon: FaGithub, bgColor: "bg-gray-900", hoverColor: "hover:bg-gray-800", 
                  ringColor: "focus:ring-gray-500" },
                { name: "Bitbucket", icon: FaBitbucket, bgColor: "bg-blue-700", hoverColor: "hover:bg-blue-600",
                  ringColor: "focus:ring-blue-400" },
                { name: "Azure Devops", icon: VscAzure, bgColor: "bg-blue-500", hoverColor: "hover:bg-blue-400",
                  ringColor: "focus:ring-blue-300" },
                { name: "Gitlabs", icon: FaGitlab, bgColor: "bg-orange-600", hoverColor: "hover:bg-orange-500",
            ...
            <div className="w-full space-y-4">
              {[
                { name: "Self Hosted Gitlab", icon: FaGitlab, bgColor: "bg-orange-600", hoverColor: "hover:bg-orange-500",
                  ringColor: "focus:ring-orange-400" },
                { name: "SSO", icon: FaKey, bgColor: "bg-gray-800", hoverColor: "hover:bg-gray-700",
                  ringColor: "focus:ring-gray-500" }
              ].map((provider) => (
                <button
                  key={provider.name}
